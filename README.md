...
**Status: v0.7.0 — the v1 feature set is complete.** Changes are in [CHANGELOG.md](./CHANGELOG.md); active work is in [STATE.md](./STATE.md) and the [issue tracker](https://github.com/OpenSDLC-Dev/managed-agent-console/issues).
...
docker run --rm -p 3000:3000 \
  ...
  ghcr.io/opensdlc-dev/managed-agent-console:0.7.0
```
...
```yaml
console:
  image: ghcr.io/opensdlc-dev/managed-agent-console:0.7.0
  ports:
    - "127.0.0.1:3000:3000"
  environment:
