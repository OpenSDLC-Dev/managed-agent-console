...
**Status: v0.2.0 — the v1 feature set is complete.** Changes are recorded in [CHANGELOG.md](./CHANGELOG.md); active work is tracked in [STATE.md](./STATE.md) and the [issue tracker](https://github.com/OpenSDLC-Dev/managed-agent-console/issues).
