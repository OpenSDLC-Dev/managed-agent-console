...
- [ ] Slice 3 — live session trace + HITL — PR #5 (unit 14/14, e2e 16/16 vs mock SSE; the plan's live acceptance against a real compose stack + model endpoint still pending — needs user-supplied credentials)
