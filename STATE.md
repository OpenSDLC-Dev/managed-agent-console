...
- [x] Inspect reference deployment and memory-store creation dialogs.
- [x] Implement modal creation, message/advanced views and trigger controls.
- [ ] Verify frequency presets, browser errors/cancellation and both-theme fidelity.
