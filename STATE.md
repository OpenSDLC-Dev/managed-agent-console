...
- [x] Confirm reference Stay/Leave behavior for edited Agent drafts.
- [x] Guard cancellation, templates, links, history and browser unload.
- [x] Complete coverage, regression and both-theme fidelity.
