...
- [x] Inspect reference searchable timezone selection.
- [x] Add timezone suggestions with exact-value fallback.
- [x] Verify selection, cancellation, persistence and both-theme fidelity.
