...
- [x] Slice 2 — the suite proves it can fail (schema canary; contract-violation probes at the trace seam and the session surface — which found and fixed a page-killing unguarded `usage` read; `probe:` convention + meta-test ratchet)
